...
VALUES (?, ?, ?, ?) RETURNING id, name, email, email_verified, image, created_at, updated_at
`
...
SELECT id, name, email, email_verified, image, created_at, updated_at FROM users WHERE email = ?
`
...
SELECT id, name, email, email_verified, image, created_at, updated_at FROM users WHERE id = ?
`
...
UPDATE users SET name = ?, image = ? WHERE id = ? RETURNING id, name, email, email_verified, image, created_at, updated_at
`
